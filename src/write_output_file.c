...
void write_output_header(control *c, FILE **fp) {
    ...
    */
    ...
    /* P stuff */
    fprintf(*fp, "puptake,pgross,pmineralisation,p_slow_biochemical,ploss,p_atm_dep,p_par_to_min,");
...
void write_daily_outputs_ascii(control *c, fluxes *f, state *s, int year,
    ...
    */
    ...
    /* P stuff */
    fprintf(c->ofp, "%.10f,%.10f,%.10f,%.10f,%.10f,%.10f,%.10f,",
                    f->puptake,f->pgross,f->pmineralisation,f->p_slow_biochemical,f->ploss,f->p_atm_dep,f->p_par_to_min);
